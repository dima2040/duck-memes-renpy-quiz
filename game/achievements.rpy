    ...
    ACHIEVEMENTS = (
        {
            ...
            "locked_description": "Полный провал ещё не оформлен как экскурсия.",
        ...
        },
        {
            ...
            "locked_description": "Один правильный ответ ещё прячется в шуме.",
            "icon": "reaction_wrong_icon",
        },
        {
            "id": "result_2",
            ...
            "locked_description": "Шум пока не получил протокол опознания.",
            "icon": "reaction_wrong_icon",
        },
        {
            "id": "result_3",
            ...
            "locked_description": "База ещё делает вид, что спит.",
            "icon": "reaction_wrong_icon",
        },
        {
            "id": "result_4",
            ...
            "locked_description": "Кодекс ещё не начал тревожно скрипеть.",
            "icon": "reaction_wrong_icon",
        },
        {
            "id": "result_5",
            ...
            "locked_description": "Ровная половина канона ещё не спасена.",
        ...
        },
        {
            ...
            "locked_description": "До легенды ещё не оставался один ответ.",
            "icon": "reaction_correct_icon",
        },
        {
            "id": "result_7",
            ...
            "locked_description": "Минимальная победа ещё ждёт своего протокола.",
            "icon": "reaction_correct_icon",
        },
        {
            "id": "result_8",
            ...
            "locked_description": "Восходящую легенду ещё не зафиксировали.",
        ...
        },
        {
            ...
            "locked_description": "Почти идеальный канон ещё не признан.",
            "icon": "reaction_canon_icon",
        },
        {
            "id": "perfect_run",
            ...
            "locked_description": "Где-то в школе ещё ждёт идеальный 10/10.",
            "icon": "reaction_canon_icon",
        },
        {
            "id": "correct_order",
        ...
        },
        {
            ...
            "locked_description": "Первый полный заход ещё ждёт звонка на урок.",
            "icon": "reaction_correct_icon",
        },
        {
            "id": "resit_accepted",
            ...
            "locked_description": "Пересдача ещё не занесена в школьный журнал.",
            "icon": "reaction_correct_icon",
        },
        {
            "id": "perfect_round",
            ...
            "locked_description": "Идеальный раунд ещё не выдержал проверку мелом.",
            "icon": "reaction_canon_icon",
        },
        {
            ...
            "locked_description": "Три раунда ещё не поставили печати подряд.",
            "icon": "reaction_canon_icon",
        },
    )
